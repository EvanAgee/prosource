...
<title>ProSource Construction - Construction Services - Flooring</title>
<!-- InstanceEndEditable -->
...
<div id="wrapper">
  ...
  <div id="content">
	...
	<h3>Flooring</h3>
	<p>Prosource Construction can install or arrange to have installed any flooring finish you may choose. As a general contractor, Prosource Construction prides itself on its working relationship with area retailers. When it comes to a specific item such as flooring, we allow the experts to do their thing. What we offer our client is all of the prep and leg work involved in the installation and the peace of mind that we will be there looking after their interest.</p>
	<div align="center" class="example_photo"><a href="../images/before_after/flooring/2_large.jpg" rel="lightbox[painting]"><img src="../images/before_after/flooring/2.jpg" width="300" height="160" border="0" class="reflex itiltnone" /></a></div>
    <div align="center" class="example_photo"><a href="../images/before_after/flooring/1_large.jpg" rel="lightbox[painting]"><img src="../images/before_after/flooring/1.jpg" width="300" height="160" border="0" class="reflex itiltnone" /></a></div>
	<!-- InstanceEndEditable -->
	</div>
