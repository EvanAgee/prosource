...
<title>ProSource Construction - Construction Services - Windows and Doors</title>
<!-- InstanceEndEditable -->
...
<div id="wrapper">
  ...
  <div id="content">
	...
	<p>Prosource Construction has been replacing windows and doors for years. What makes us different from other contractors is the fact that we will not cover up any other problems. Common sense will dictate that if a window is bad and has been bad for a time, then the chances are that the framing and sills around the window are bad from the elements being able to get to them. Trade standard is if you are hired to replace a window, then you replace a window. If you hire Prosource Construction to replace a window, we will do just that, however; if there are other problems, we will show the homeowner and come to an agreement on the best way to fix the problem. It does nobody any good to cover up an existing problem.	</p>
	<p>We are also available for those homeowners who install new <a href="flooring.php">flooring</a> and need their doors cut down as not to rub on the new flooring.</p>
	<!-- InstanceEndEditable -->
	</div>
