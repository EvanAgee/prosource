...
$recipient = "prosource@parallax.ws"; // youremail@domain.com

// bcc emails (separate multiples with commas (,))
$bcc = "evanagee@gmail.com";

$required = 'realname,email,Street,City,State,Zip,Phone,YourQuestion';

// referers.. domains/ips that you will allow forms to
// reside on.
$referers = array ('prosourcefirst.com','www.prosourcefirst.com','121.0.0.111');
